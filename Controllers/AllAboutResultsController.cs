    ...
    public class AllAboutResultsController : Controller
    {
        public IActionResult Index()
        {
            ...
            switch (day)
            {
                case "Monday":
                case "Tuesday":
                    ViewData["dayMessage"] = "The work week just started! Saty Focused, you have a lot to do this week!";
                    route = 1;
                    break;
                case "Wednesday":
                    ViewData["dayMessage"] = "Halfway to teh weekend!";
                    route = 2;
                    break;
                case "Thursday":
                    ...
                    break;
                case "Friday":
                    ViewData["dayMessage"] = "Yippy Skippy! TGIF!!";
                    route = 4;
                    break;
                default:
                    ViewData["dayMessage"] = "Ahhhhhhhhhhhhhh the weekend!!!";
                    route = 5;
                    break;
            }
            if (route==1)
